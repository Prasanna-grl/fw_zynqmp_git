...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x80000000U)
    */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(AFIFM3_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Configures the Read Channel Fabric interface width. 2'b11 : Reserved 2'b
    * 10 : 32-bit Fabric 2'b01 : 64-bit enabled 2'b00 : 128-bit enabled
    *  PSU_AFIFM5_AFIFM_RDCTRL_FABRIC_WIDTH                        0x2

    * Read Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFD3B0000, 0x00000003U ,0x00000002U)
    */
	PSU_Mask_Write(AFIFM5_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(AFIFM3_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Configures the Write Channel Fabric interface width. 2'b11 : Reserved 2'
    * b10 : 32-bit Fabric 2'b01 : 64-bit enabled 2'b00 : 128-bit enabled
    *  PSU_AFIFM5_AFIFM_WRCTRL_FABRIC_WIDTH                        0x2

    * Write Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFD3B0014, 0x00000003U ,0x00000002U)
    */
	PSU_Mask_Write(AFIFM5_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000002U);
/*##################################################################### */
